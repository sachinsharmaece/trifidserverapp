...
| --- | ------------------------------------------------------------------ | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | No PO against an SO that is not paid in full                       | ✅ **interim enforced (M10)** | Single-SO: `chainM4.test.ts:249` (none posted · partial · second PO); concurrent payments `chainM4.test.ts:908`. **The M9 hole is closed by an interim guard:** a receipt names exactly one SO — `m9Invariants.test.ts` (_REFUSES one receipt allocated to two SOs_, plus the refused-at-posting and two-receipts workaround cases). `QR-057` stays open for the real apportionment rule. |
